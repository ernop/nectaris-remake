...
| Board orientation and control docking | Updated by the user's 2026-09-25 correction: fixed left controls/metadata in matches and replays, full-height board, independent panel scrolling and no content-driven board reflow. Auto / Normal / Sideways orientation remains. [Layout behavior](PRODUCT.md#board-orientation-and-control-docking-2026-09-23). |
