...
| Battle review in matches and replays | Implemented from the user's 2026-09-25 request: selection then the action, a dock under the map with destroyed/lost counts, the match's actual damage roll against the 100-row table, and a per-side gap versus the average. [Readout and replay controls](PRODUCT.md#battle-review-2026-09-25). |
