...
module.exports = function (ok) {
  ...
  ok(maps.length === 15 && new Set(maps.map(function (m) {return JSON.stringify(m.grid);})).size === 15,
    "all fifteen AI-made maps have distinct layouts");
  ...
  require("./curiosity-maps-tests.js")(ok);
